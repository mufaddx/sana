...
import { ArrowLeft, ArrowRight, ArrowUp, Brain, BriefcaseBusiness, Check, CheckCircle2, ChevronDown, CircleHelp, ClipboardCheck, Cpu, FlaskConical, Gauge, Globe2, GraduationCap, Lightbulb, Menu, Radar, Scale, Search, Send, ShieldCheck, Sparkles, Target, Users, X, Zap } from 'lucide-react';
...
function Router() {
  ...
  return <ErrorBoundary resetKey={location}><Switch><Route path="/" component={Home} /><Route path="/assessment" component={AssessmentPage} /><Route path="/admin" component={AdminPage} /><Route path="/privacy" component={() => <LegalPage kind="privacy" />} /><Route path="/terms" component={() => <LegalPage kind="terms" />} /><Route component={NotFound} /></Switch></ErrorBoundary>;
}
