...
function Home() {
  ...
  return <div className="site-shell" id="top"><Header />
    <main>
      <section className="hero"><div className="container-rwl hero-grid"><div className="reveal"><div className="eyebrow">Career discovery for students</div><h1>Discover your potential.<br /><em>Find your path.</em></h1><p className="hero-copy">Explore your interests, understand your strengths and discover career fields that may be a strong fit for you.</p><div className="hero-actions"><Link href="/assessment" className="button-primary" data-testid="link-hero-assessment">Start Your Assessment <ArrowRight size={16} /></Link><a href="#career-fields" className="button-secondary" data-testid="link-hero-fields">Explore Career Fields</a></div><div className="hero-note"><ShieldCheck size={15} /> A thoughtful starting point, never a promise about your future.</div></div><div className="hero-visual reveal"><div className="visual-main"><div className="orbit one" /><div className="orbit two" /><div className="visual-portrait"><div className="portrait-head" /><div className="portrait-body" /><div className="portrait-arm" /></div></div><div className="visual-card top"><span className="card-label">Your next question</span><strong>What makes you curious?</strong></div><div className="visual-card bottom"><span className="card-label">Career discovery</span><strong>Based on your interests</strong><div className="mini-path"><i /><i /><i /></div></div></div></div></section>
